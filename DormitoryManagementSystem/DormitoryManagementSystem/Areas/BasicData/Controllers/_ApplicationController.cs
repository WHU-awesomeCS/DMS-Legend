...
namespace DormitoryManagementSystem.BasicData.Controllers
{
    ...
    [ActionDescription("_Model.Application")]
    [ApiController]
    [Route("/api/BasicData/Application")]
    public partial class ApplicationController : BaseApiController
    {
        ...
        {
            var vm = Wtm.CreateVM<ApplicationVM>(id);
            return Ok(vm);
        }
        ...
        [HttpPut("[action]")]
        public async Task<IActionResult> Edit(ApplicationVM vm)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState.GetErrorJson());
        ...
        public ActionResult BatchEdit(ApplicationBatchVM vm)
        {
        ...
        {
            var vm = Wtm.CreateVM<ApplicationBatchVM>();
        ...
        {
            var vm = Wtm.CreateVM<ApplicationImportVM>();
        ...
        [HttpPost("Import")]
        public ActionResult Import(ApplicationImportVM vm)
        {
